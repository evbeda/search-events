...
class DBService:
    ...
    def format_query(cls, dto_filters_array):
        select_base_query = QueryParameters.columns_select
        join_base_query = QueryParameters.default_tables
        where_base_query = QueryParameters.constraints
        group_by_base_query = QueryParameters.group_by
        order_by_base_query = QueryParameters.order_by
