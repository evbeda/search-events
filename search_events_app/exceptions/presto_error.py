...
class PrestoError(Exception):
    ...
    def __init__(self, exception):
        if isinstance(exception, SSLError):
            ...
            self.message = 'Download your certificate <a target="_blank" href="https://docs.evbhome.com/intro/self_signed_certs.html">HERE</a>'
            ...
            self.message += '<a target="_blank" href="https://docs.evbhome.com/intro/self_signed_certs.html">link</a> '
